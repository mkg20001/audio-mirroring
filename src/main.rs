...
pub enum GtkMessage {
    ...
    /// Create a link between the two specified ports (if it doesn't exist).
    CreateLink { port_from: u32, port_to: u32 },
    /// Remove a link between the two specified ports (if it exists).
    RemoveLink { port_from: u32, port_to: u32 },
